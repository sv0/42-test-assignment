...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_profile', (
            ...
            ('bio', self.gf('django.db.models.fields.TextField')(max_length=1024, blank=True)),
            ...
            ('other_contacts', self.gf('django.db.models.fields.TextField')(max_length=512, blank=True)),
